"""Admin for the Department taxonomy."""
...
class DepartmentAdmin(ModelAdmin):
    ...
    def usage_summary(self, obj):
        """How much content references this department."""
        return f"{obj.events.count()} events · {obj.blogs.count()} blogs · {obj.faculty_members.count()} faculty"
